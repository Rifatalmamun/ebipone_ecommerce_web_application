	...
	<main>
            <div class="container-fluid site-width">
                ...
                <div class="row">
                    <div class="col-12 align-self-center">
                        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Customer Details. 
                                    ...
                                    @if ($customer->avatar!=null)
                                        <img src="{{asset($customer->avatar)}}" style="width: 70px; height: 70px; border-radius: 50%;">
                                    @endif
                        ...
                        @php
                                ...
                                <br>
                                @foreach ($note as $n)
                                    <span class="badge badge-secondary mb-1">{{$n->note}} ({{$n->date}}-{{$n->time}})</span> 
                                @endforeach	
                    </div>
                </div>
                <!-- END: Breadcrumbs-->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <dl class="row mb-0 redial-line-height-2_5">
                                    ...
                                    <dd class="col-sm-7"><span class="text-danger font-weight-bold">{{$customer->phone}}</span></dd> 
                                    
                                    <dt class="col-sm-5">Shop</dt>
                                    
                                    @if ($customer->shop_name!=null)
                                    <dd class="col-sm-7"><span ><a href="{{URL::to('admin/view/shop/'.$customer->id)}}" class="text-danger font-weight-bold">{{$customer->shop_name}}</a></span></dd>
                                    @else
                                    <dd class="col-sm-7"><span >----</span></dd> 
                                    @endif

                                    <dt class="col-sm-5">Area/Village</dt>
                                    <dd class="col-sm-7"> {{$customer->village}} </dd>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <dl class="row mb-0 redial-line-height-2_5"> 
                                    ...
                                    <dt class="col-sm-5">Main Balance</dt>
                                    <dd class="col-sm-7">৳ {{$customer->user_balance}} </dd>

                                    <dt class="col-sm-5">Cashback Balance</dt>
                                    <dd class="col-sm-7">৳ {{$customer->user_cashback}} </dd>

                                    <dt class="col-sm-5">Gift Balance</dt>

                                    @if ($customer->user_giftbalance!=null)
                                        <dd class="col-sm-7">৳ {{$customer->user_giftbalance}} </dd>
                                    @else
                                        <dd class="col-sm-7">৳ 0 </dd>
                                    @endif

                                    <dt class="col-sm-5">Gift Pending</dt>
                                    <dd class="col-sm-7">৳ {{$customer->gift_pending}} </dd>

                                    <dt class="col-sm-5">Country</dt>
                                    <dd class="col-sm-7"> Bangladesh </dd>

                                    <dt class="col-sm-12"> <a href="{{URL::to('admin/edit/customer/'.$customer->id)}}" class="text-danger" target="_blank">Click to Edit Customer Data</a> </dt>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h6 class="my-3 font-weight-bold text-info">Customer Order List</h6>
                    ...
                    <div class="col-md-4">
                        <h6 class="my-3 font-weight-bold text-info">Money Upload</h6> 

                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="examplee" class="display table dataTable table-striped table-bordered" >
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                @foreach ($customerUploadMoney as $item)
                                                    <tr>
                                                        <td> {{$item->order_date}} </td>
                                                        <td> {{$item->order_time}} </td>
                                                        <td> {{$item->pay_price}} </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{route('admin.update.customer')}}" method="POST">
                                    ...
                                    <input type="submit" class="btn btn-primary w-25 mb-5" value="Update Customer Data">
