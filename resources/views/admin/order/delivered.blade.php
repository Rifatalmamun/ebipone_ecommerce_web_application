                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      @elseif($item->admin_status=='delivery complete')
                                      <span class="badge badge-primary">{{$item->admin_status}}</span>
                                      @endif
                                  </td> 
                                  ...
                                  <td>
                                    ...
                                    <a href="{{URL::to('admin/show/order/'.$item->id)}}" data-toggle="tooltip" title="" data-original-title="View Order" ><i class="fa fa-eye"></i></a> 
