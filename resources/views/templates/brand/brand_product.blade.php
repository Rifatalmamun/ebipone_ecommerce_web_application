            ...
            <div class="row">
                <div class="col-12 col-lg-3 d-flex">
                        ...
                        <div class="account-nav flex-grow-1">
                            <h4 class="text-dark account-nav__title"> <i class="fa fa-list-alt"></i> Brands</h4>
                            <ul class="widget-categories__list widget-categories__list--root" data-collapse data-collapse-opened-class="widget-categories__item--open">
                                ...
                                <li class="widget-categories__item" data-collapse-item> 
                                    <a href="{{URL::to('brand/'.Str::slug($item->brand_name))}}" class="widget-categories__link"> {{$item->brand_name}} </a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                ...
                <div class="col-12 col-lg-9 mt-4 mt-lg-0">
                        ...
                        @if ($count==0)
                        <div class="card">
                            <div class="text-dark card-header"><h5>No Product!</h5></div>
                                                        ...
                                                        <div class="products-list__item">
                                                            <div class="product-card">
                                                                ...
                                                                <div class="product-card__footer">
                                                                    <div class="product-card__prices"><div class="product-card__price product-card__price--current"> {{$item->present_price}} BDT</div></div>
                                        ...
                                        <div class="block-split__item block-split__item-content col">
                                            <div class="block">
                                                ...
                                                <div class="products-view">
                                                    ...
                                                    <div class="products-view__list products-list products-list--grid--4" data-layout="grid" data-with-features="false">
                                                        <div class="products-list__head">
                                                            <div class="products-list__column products-list__column--image">Others Brand Product</div>
                                                            
                                                        </div>
                                                        <div class="products-list__content">
                                                            
                                                            @foreach ($others_products as $item)
                                                            <div class="products-list__item">
                                                                <div class="product-card">
                                                                    <div class="product-card__actions-list">
