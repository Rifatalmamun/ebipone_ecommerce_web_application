                ...
                <div class="col-12 col-lg-12 mt-1 mt-lg-0">
                    <div class="dashboard">
                          ...
                          <div class="w3-bar mt-3" style="background: #F0F0F0">
                            ...
                            <button style="width: 25%; background: #CCCCCC;" id="pr" class="w3-bar-item w3-button" onclick="openCity('Paris')">Pickup Point Pending ({{$shop_to_pickup_point_pending_order_count}})</button>
