                        ...
                        <ul class="widget-categories__list widget-categories__list--root" data-collapse data-collapse-opened-class="widget-categories__item--open">
                            ...
                            <li class="widget-categories__item" data-collapse-item>
                                @if($item->category_name)
					                <a href="#" class="widget-categories__link"> {{$item->category_name}} </a>
				                @endif
                                @php
                                    ...
                                    <ul class="widget-categories__list widget-categories__list--child">
                                        ...
                                        <button class="widget-categories__expander" type="button" data-collapse-trigger></button>
                                                <li class="widget-categories__item">
                                                    ...
                                                    <a href="#" class="widget-categories__link">{{$item->subcategory_name}}</a>
                                                    @endif
...
c-3.9,0-7,3.1-7,7s3.1,7,7,7s7-3.1,7-7S18.9,2,15,2z M16,13h-2v-3h-3V8h3V5h2v3h3v2h-3V13z"
    ...
    -->
                                        <a class="image image--type--product" href="{{asset($shop_product->image_one)}}" target="_blank" data-width="700" data-height="700" >
                                            <div class="image__body"><img class="image__tag" src="{{asset($shop_product->image_one)}}" alt="" /></div>
                                        </a>

                                        <a class="image image--type--product" href="{{asset($shop_product->image_two)}}" target="_blank" data-width="700" data-height="700" >

                                            <div class="image__body"><img class="image__tag" src="{{asset($shop_product->image_two)}}" alt="" /></div>
                                        </a>

                                        <a class="image image--type--product" href="{{asset($shop_product->image_three)}}" target="_blank" data-width="700" data-height="700">
                                            <div class="image__body"><img class="image__tag" src="{{asset($shop_product->image_three)}}" alt="" /></div>
                                        </a>
                                        
                                        <a class="image image--type--product" href="{{asset($shop_product->image_four)}}" target="_blank" data-width="700" data-height="700">

                                            <div class="image__body">
                                                <img class="image__tag" src="{{asset($shop_product->image_four)}}" alt="" /> 
                                            </div>
                                        </a>
                                ...
                                <div class="product-gallery__thumbnails">
                                    <div class="owl-carousel">
                                        ...
                                        <div class="product-gallery__thumbnails-item image image--type--product">
                                            <div class="image__body"><img class="image__tag" src="{{asset($shop_product->image_four)}}" alt="" /></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="product__header">
                                <h1 class="product__title">{{$shop_product->product_name}}</h1>
                                    ...
                                    <div class="status-badge status-badge--style--success product__fit status-badge--has-icon status-badge--has-text">
                                        <div class="status-badge__body">
                                            ...
                                            <div class="status-badge__text">
                                                {{$shop_product->category_name}} --- {{$shop_product->subcategory_name}}
                                            </div>
                                ...
                                <div class="product__info-card">
                                    <div class="product__info-body">
                                        ...
                                        <div class="product__prices-stock">
                                            <div class="product__prices"><div class="product__price product__price--current">{{$shop_product->selling_price}} TK</div>
                                        </div>
                                        ...
                                        <div class="product__meta">
                                            <table>
                                                ...
                                                <tr>
                                                    <th>Category</th>
                                                    <td><a href="#">{{$shop_product->category_name}}</a></td>
                                                </tr>
                                                <tr>
                                                    <th>Sub category</th>
                                                    <td><a href="#">{{$shop_product->subcategory_name}}</a></td>
                                                </tr>
                                                <tr>
                                                    <th>Shop code</th>                                           
                                                ...
                                                <div class="product-form__control">
                                                    <div class="input-radio-color">
                                                        <div class="input-radio-color__list">
                                                            ...
                                                            @if ($shop_product->black=='1')
                                                                <label class="input-radio-color__item" style="color: black;" data-toggle="tooltip" title="Black"> <span></span></label>
                                                            @endif

                                                            @if ($shop_product->red=='1')
                                                                <label class="input-radio-color__item" style="color: red;" data-toggle="tooltip" title="Red"> <span></span></label>
                                                            @endif

                                                            @if ($shop_product->white=='1')
                                                                <label class="input-radio-color__item" style="color: white;" data-toggle="tooltip" title="White"> <span></span></label>
                                                            @endif

                                                            @if ($shop_product->blue=='1')
                                                                <label class="input-radio-color__item" style="color: blue;" data-toggle="tooltip" title="Blue"> <span></span></label>
                                                            @endif



                                                            @if ($shop_product->green=='1')
                                                                <label class="input-radio-color__item" style="color: green;" data-toggle="tooltip" title="Green"> <span></span></label>
                                                            @endif


                                                            @if ($shop_product->yellow=='1')
                                                                <label class="input-radio-color__item" style="color: yellow;" data-toggle="tooltip" title="Yellow"> <span></span></label>
                                                            @endif
                                        ...
                                        <div class="spec">
                                            <div class="spec__section">
                                                ...
                                                <div class="spec__row">
                                                    ...
                                                    <div class="spec__value">{{$shop_product->product_name}}</div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Category</div>
                                                    <div class="spec__value"> {{$shop_product->category_name}} </div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Sub category</div>
                                                    <div class="spec__value"> {{$shop_product->subcategory_name}} </div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Price</div>
                                                    <div class="spec__value"> {{$shop_product->selling_price}} TK</div>
                                                </div>
                                                
                                            </div>
                                            <div class="spec__section">
                                                <h4 class="spec__section-title">Authentication</h4>
                                                <div class="spec__row">
                                                    <div class="spec__name">Shop name</div>
                                                    <div class="spec__value"> {{$shop_product->shop_name}} </div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Product Code</div>
                                                    <div class="spec__value"> {{$shop_product->product_code}} </div>
                                                </div>
