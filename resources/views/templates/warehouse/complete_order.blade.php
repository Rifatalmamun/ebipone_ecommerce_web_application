                ...
                <div class="col-12 col-lg-12 mt-1 mt-lg-0">
                    <div class="dashboard">
                          ...
                          <div class="w3-bar mt-3" style="background: #F0F0F0">
                            ...
                            <button style="width: 20%; background: #CCCCCC;" id="cm" class="w3-bar-item w3-button" onclick="openCity('Com')">Delivery Complete ({{$count_customer_received_product}})</button>
                          ...
                          <div id="Com" class="w3-container city" style="padding: 0 0; width: 100%;">
