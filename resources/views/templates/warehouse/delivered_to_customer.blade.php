                ...
                <div class="col-12 col-lg-12 mt-1 mt-lg-0">
                    <div class="dashboard">
                          ...
                          <div class="w3-bar mt-3" style="background: #F0F0F0">
                            ...
                            <button style="width: 20%;background: #CCCCCC;" id="tk" class="w3-bar-item w3-button" onclick="openCity('Tokyo')">Delivery Pending ({{$count_customer_delivery_pending_product}})</button>
