...
<div class="site__body">
    ...
    <div class="block block-slideshow">
        <div class="container">
            <div class="block-slideshow__carousel">
                <div class="owl-carousel">
                    <a class="block-slideshow__item" href="https://www.ebipone.com/EB62008066/t-shirt"> 
                        <span class="block-slideshow__item-image block-slideshow__item-image--desktop" style="background-image: url('public/frontend/images/slides/1takatshirt.jpg');"></span>
                        <span class="block-slideshow__item-image block-slideshow__item-image--mobile" style="background-image: url('public/frontend/images/slides/1takatshirtmobile.jpg');"></span>
                    ...
                    <a class="block-slideshow__item" href="https://www.ebipone.com/register">
                        <span class="block-slideshow__item-image block-slideshow__item-image--desktop" style="background-image: url('public/frontend/images/slides/cashback.jpg');"></span>
                        <span class="block-slideshow__item-image block-slideshow__item-image--mobile" style="background-image: url('public/frontend/images/slides/cashbackmobile.jpg');"></span>
                        <span class="block-slideshow__item-offer">eBipone</span>
                        <span class="block-slideshow__item-title">
                            Your Best Online<br />
                            Shoping Mall
                    ...
                    @foreach ($shop as $item)
                        <div class="col-lg-2 col-sm-4 col-md-3 col-4 mb-3" >
                            <div class="card rounded" style="min-height: 160px;padding: 10px 0;;">
                                <a href="{{URL::to('shop/'.Str::slug($item->shop_name))}}" class="block-brands__item-link" style="padding: 5px 0px;">

                                    @if ($item->shop_logo!=null)
                                        <img src="{{asset($item->shop_logo)}}" class="card-img-top" style="width: 80%;height: 140px;margin-left: 10%;" alt="Shop logo">
                                    @else
                                        <img src="{{asset('public/media/shop_logo/shop_logo.png')}}" alt="Shop logo" style="width: 80%;height: 140px;margin-left: 10%;"/> 
                                    @endif

                                    <div class="card-body">
                                        <p class="card-text text-center text-dark" style="font-size: 15px;">{{$item->shop_name}}</p>
                                    </div>
                            ...
                            <div class="card rounded" style="min-height: 160px;padding: 10px 0;;">
                                <a href="{{route('all.shop')}}" class="block-brands__item-link" style="padding: 5px 0px;">
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <h4 class="font-weight-bold text-danger" style="text-align: center; margin-top: 12%;">Find More</h4>
                                        <i class="fa fa-ellipsis-h text-danger" aria-hidden="true" style="display: block;text-align: center;"></i>
                                    </div>
        ...
        <div class="block block-brands block-brands--layout--columns-8-full">    
                ...
                <div class="container">
                    <h6 class="mb-2">Shop by Brands</h6>   <hr>
                    <div class="row">
    
                        @foreach ($brands as $item)
                        <div class="col-lg-2 col-sm-4 col-md-3 col-4 mb-3" >
                            <div class="card rounded" style="min-height: 160px;padding: 10px 0;;">
                                <a href="{{URL::to('brand/'.Str::slug($item->brand_name))}}" class="block-brands__item-link" style="padding: 5px 0px;">

                                    <img src="{{asset($item->brand_picture)}}" class="card-img-top" style="width: 80%;height: 140px;margin-left: 10%;">

                                    <div class="card-body">
                                        <p class="card-text text-center text-dark" style="font-size: 15px;">{{$item->brand_name}}</p>
                                    </div>
			...
			<div class="col-lg-2 col-sm-4 col-md-3 col-4 mb-3" >
                            <div class="card rounded" style="min-height: 160px;padding: 10px 0;;">
                                <a href="{{route('brand')}}" class="block-brands__item-link" style="padding: 5px 0px;">
        ...
        <!-- fetch data according to section category id -->
        ...
        @php
            ...
            $sub = DB::table('subcategories')->where('category_id',$item->category_id)->take(4)->get();
            $slide_products = DB::table('products')->where('category_id',$item->category_id)->where('status','active')->where('show_home','1')->get();
            ...
            <div class="container">
                <div class="section-header">
                    <div class="section-header__body">
                        <h2 class="section-header__title text-dark">{{$item->section_title}}</h2>
                        ...
                        <ul class="section-header__groups">
                            ...
                            @foreach ($subIds_explode as $subcat)

                                @php
                                    $getDB = DB::table('subcategories')->where('id',$subcat)->first();
                                    $getDB_count = DB::table('subcategories')->where('id',$subcat)->count();
                                @endphp
                                    @if ($getDB_count>0)

                                    <li class="section-header__groups-item"><button type="button" class="section-header__groups-button ">{{$getDB->subcategory_name}}</button></li>
                ...
                <div class="block-products-carousel__carousel">
                    ...
                    <div class="owl-carousel">
                        <!--single product-->
                        @foreach ($slide_products as $item)
                            ...
                            <div class="block-products-carousel__cell">
                                <div class="product-card product-card--layout--grid">
                                    <div class="product-card__actions-list">
                                        ...
                                        <button class="addcompare product-card__action product-card__action--compare" type="button" aria-label="Add to compare" data-id="{{ $item->id }}">    
                                                    <svg width="16" height="16">
                                    ...
                                    <div class="product-card__image">
                                        <div class="image image--type--product">
                                            <a href="{{URL::to($item->un_id.'/'.Str::slug($item->product_name))}}" class="image__body">
                                                <img class="image__tag" src="{{asset($item->image_one)}}"/> 
                                            </a>
                                        </div>
                                    ...
                                    <div class="product-card__info">
                                        <div class="product-card__meta mt-2"><span class="product-card__meta-title"></span> {{$item->product_name}} </div>
                        ...
                        @foreach ($subIds_explode as $subcat)
                            ...
                            @if ($getDB_count>0)
                                @php
                                    $subItemsProducts = DB::table('products')->where('subcategory_id',$getDB->id)->where('show_home','1')->get();
                                @endphp
                                <!--sub category wise single product-->
                                @foreach ($subItemsProducts as $item)
                                ...
                                <div class="block-products-carousel__column">                
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--layout--grid">
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="{{URL::to($item->un_id.'/'.Str::slug($item->product_name))}}" class="image__body"><img class="image__tag" src="{{asset($item->image_one)}}" alt="" /></a>
                                                </div>
                                                <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                    {{-- <div class="status-badge__body">
                                                        ...
                                                        <div class="status-badge__tooltip" tabindex="0" data-toggle="tooltip" title="test"></div>
                                                    </div> --}}
                                                </div>
                                            </div>
                                            <div class="product-card__info">
                                                <div class="product-card__meta"><span class="product-card__meta-title"></span> {{$item->product_name}} </div>
                                                <div class="product-card__name">
                                                    {{-- <div>
                                                        <div class="product-card__badges">
                                                            <div class="tag-badge tag-badge--new">new</div>
                                                        </div>
                                                        <a href="{{URL::to('product/'.$item->id)}}">{{$item->product_name}}</a>
                                                    </div> --}}
                                                </div>
                                                <div class="product-card__rating">
    ...
    <div class="block-banners block">
        <div class="container">
            <div class="block-banners__list">
                <a href="https://www.ebipone.com/EB62008066/t-shirt" class="block-banners__item block-banners__item--style--one">
                    <span class="block-banners__item-image"><img src="images/banners/banner1.jpg" alt="" /></span>
                    <span class="block-banners__item-image block-banners__item-image--blur"><img src="images/banners/banner1.jpg" alt="" /></span><span class="block-banners__item-title">1 Taka T-Shirt</span>
                    <span class="block-banners__item-details">
                        T-Shirt for 1 taka only.<br />
                        For new user
                    </span>
                    <span class="block-banners__item-button btn btn-primary btn-sm">Shop Now </span>
                </a>
                <a href="https://www.ebipone.com/register" class="block-banners__item block-banners__item--style--two">
                    <span class="block-banners__item-image"><img src="images/banners/banner2.jpg" alt="" /></span>
                    <span class="block-banners__item-image block-banners__item-image--blur"><img src="images/banners/banner2.jpg" alt="" /></span><span class="block-banners__item-title">100% Gift Balance</span>
                    <span class="block-banners__item-details">
                        When new user upload money to ebipone<br />
                        You will get 100% Gift balance for shopping.
                    </span>
                    <span class="block-banners__item-button btn btn-primary btn-sm">Shop Now</span>
                </a>
            </div>
    ...
    <div class="block block-products-columns">
        <div class="container">
            <div class="row">
                            ...
                            <div class="product-card">
                                ...
                                <div class="product-card__info">
                                    ...
                                    <div class="product-card__rating">
                                        ...
                                        <div class="product-card__rating-label">{{$item->product_name}}</div>
                                    </div>
                                </div>
                                <div class="product-card__footer">
                                    <div class="product-card__prices"><div class="product-card__price product-card__price--current">৳ {{$item->present_price}} </div></div>
                ...
                <div class="col-4">
                    <div class="block-products-columns__title">Special Products</div> 
                    <div class="block-products-columns__list">
                        @php
                ...
                <div class="col-4">
                    <div class="block-products-columns__title">Best Sellers</div> 
                    <div class="block-products-columns__list">
                        @php
                            $bestSell =  DB::table('products')
                                        ->join('users','users.id','products.product_owner_id')
                                        ->join('categories','categories.id','products.category_id')
                                        ->join('subcategories','subcategories.id','products.subcategory_id') 
                                        ->select('products.*','users.name','users.shop_name','users.shop_id','categories.category_name','subcategories.subcategory_name')->where('products.status','active')->where('products.show_home','1')
            ...
            <ul class="block-features__list">
                <li class="block-features__item">
                    ...
                    <div class="block-features__item-info">
                        <div class="block-features__item-title">100%Cashback Offer</div>
                        <div class="block-features__item-subtitle">First time upload only</div>
                    </div>
                </li>
                <li class="block-features__item">
                    <div class="block-features__item-icon">
                ...
                <li class="block-features__item">
                    ...
                    <div class="block-features__item-info">
                        ...
                        <div class="block-features__item-subtitle">Secuire by SSLCommerz</div>
                    </div>
                </li>
                <li class="block-features__item">
                    <div class="block-features__item-icon">
                    ...
                    <div class="block-features__item-info">
                        ...
                        <div class="block-features__item-subtitle">Gift Ballance 100%</div>
                    </div>
                </li>
            </ul>
        </div>
